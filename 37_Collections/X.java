...
class X {
    public static void main(String[] args) {
        ...
        Student1 x = new Student1("golu", 9);
        System.out.println(list.contains(x));//internally equals called and if overrided then ok otherwise parent object equals called
