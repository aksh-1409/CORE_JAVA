...
class Y {
    public static void main(String[] args) {
        ...
        Student1 x = new Student1("raghav", 18);
        System.out.println(list.remove(x));//internally equals called and if overrided then ok otherwise parent object equals called
