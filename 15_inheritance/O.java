...
// O.java:25: error: incompatible types: BDog cannot be converted to Cat
//         System.out.println(x instanceof Cat);
//                            ^
// O.java:26: error: incompatible types: BDog cannot be converted to Cow
//         System.out.println(x instanceof Cow);
//                            ^
// O.java:27: error: incompatible types: BDog cannot be converted to Plant
//         System.out.println(x instanceof Plant);
//                            ^
// O.java:28: error: incompatible types: BDog cannot be converted to Human
//         System.out.println(x instanceof Human);
//                            ^
// 4 errors